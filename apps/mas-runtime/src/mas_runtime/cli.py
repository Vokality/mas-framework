...
from mas_runtime.runner import main as runner_main
...
def main(argv: list[str] | None = None) -> None:
    ...
    # Preserve existing behavior: `python -m mas_runtime` runs the runner.
    if not argv:
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="mas-runtime", description="MAS Framework CLI"
    )
