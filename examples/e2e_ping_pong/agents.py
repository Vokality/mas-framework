...
class PongAgent(Agent[DoctorState]):
    ...
    async def handle_patient_message(
        ...
        doctor_lines = [
            ...
            "That sounds like a viral upper respiratory infection. "
            "I will listen to your lungs and check your vitals.",
            "I recommend rest, fluids, and an over-the-counter cough suppressant. "
            "If symptoms worsen or last more than two weeks, follow up.",
        ]
...
class PingAgent(Agent):
    ...
    async def on_start(self) -> None:
        ...
        patient_lines = [
            "Hi Doctor. I have had a cough for about a week and it is keeping me "
            "up at night. james@gmail.com",
            "It started after a cold. The cough is dry and my throat feels scratchy.",
            "No fever or chest pain. I get a little winded when I climb stairs, "
            "but nothing severe.",
            "I have been drinking tea and using lozenges. "
            "I have not taken any medicines yet.",
